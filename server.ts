...
export function createServer(options: { subscribeUrl?: string; providers: TaseDataProviders }): McpServer {
  ...
  // Resource URIs
  const myPositionResourceUri = "ui://tase-end-of-day/my-position-table-widget-v7.html";
  const sectorHeatmapResourceUri = "ui://tase-end-of-day/market-sector-heatmap-widget-v7.html";
  const endOfDayResourceUri = "ui://tase-end-of-day/market-end-of-day-widget-v8.html";
  const marketSpiritResourceUri = "ui://tase-end-of-day/market-spirit-widget-v7.html";
  const uptrendSymbolsResourceUri = "ui://tase-end-of-day/market-uptrend-symbols-widget-v7.html";
  const endOfDaySymbolsResourceUri = "ui://tase-end-of-day/my-position-end-of-day-widget-v8.html";
  const candlestickResourceUri = "ui://tase-end-of-day/symbol-candlestick-widget-v7.html";
  const symbolsCandlestickResourceUri = "ui://tase-end-of-day/my-position-candlestick-widget-v7.html";
  const dashboardResourceUri = "ui://tase-end-of-day/market-dashboard-widget-v7.html";
  const subscriptionResourceUri = "ui://tase-end-of-day/tase-market-landing-widget-v9.html";
  const myPositionsManagerResourceUri = "ui://tase-end-of-day/my-positions-manager-widget-v5.html";
  const symbolsEndOfDayResourceUri = "ui://tase-end-of-day/symbols-end-of-day-widget-v5.html";
